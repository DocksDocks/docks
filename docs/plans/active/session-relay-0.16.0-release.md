...
updated: "2026-08-04T06:25:51.548+00:00"
started_at: null
finished_at: null
assignee: null
...
| A20 | `node --input-type=module -e 'import fs from "node:fs"; import { validateSourcePreparationProof } from "./scripts/lib/session-relay-release-preparation.mjs"; const p=JSON.parse(fs.readFileSync("/home/vagrant/.local/state/docks/release/session-relay-0.16.0/source-proof-s8.json","utf8")); delete p.ancestry.plan_source_to_implementation; validateSourcePreparationProof(p);'` | Exit 0 after step:restore_closed_v3; the current successor proof validates with the original V3 ancestry keys. Before the repair it fails `current source proof ancestry has unknown or missing fields`. |
