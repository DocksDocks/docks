...
| 6 | stale_refs | Retarget the scope-waiver keys naming moved suites and, in the five other active plans, every citation of a path this plan moves - the `affected_paths` entry, the Steps `Files` cell and the acceptance command. Two of them bind `node plugins/plan-lifecycle/test/selftest.mjs` as an acceptance row, which step:move_suites relocates, so a stale command there would fail at their own acceptance rather than here. so no live record cites a path this plan deleted, and re-derive the scope-waiver pairs this plan owns, whose frozen-evidence entries are keyed to the pre-move suite paths and go stale the moment step 3 lands. Leave every finished record and every frozen release-instance JSON untouched. | `docs/plans/active/plan-lifecycle-derived-history-navigation.md`; `docs/plans/active/plan-lifecycle-review-and-authority-modules.md`; `docs/plans/active/plan-lifecycle-review-dispatch-performance.md`; `docs/plans/active/session-relay-post-cutover-modules.md`; `docs/plans/active/session-relay-typed-irc-sqlite.md`; `scripts/config/plan-scope-waivers/plan-lifecycle-review-and-authority-modules.json`; `scripts/config/plan-scope-waivers/session-relay-payload-boundary.json` | 5 | `local` | `planned` | Every path cited by the `affected_paths` of the five other active plans - `plan-lifecycle-derived-history-navigation`, `plan-lifecycle-review-and-authority-modules`, `plan-lifecycle-review-dispatch-performance`, `session-relay-post-cutover-modules` and `session-relay-typed-irc-sqlite` - resolves on disk, reported as zero unresolved entries. The record of this plan is deliberately excluded: a move plan must cite both the pre-move paths it deletes and the post-move paths it creates, so 86 of its entries are tombstones by design. `node scripts/tests/plan-orchestration.mjs` exits 0. Failure: STOP; never edit a finished record to make a scan pass. |
...
Plan-run: {"acceptance":null,"blocker":{"evidence_sha256":"ac71e0cb4b0b822403e01ed208bb2ea4b77d9738cb39675a2e89979344774087","kind":"review_failed"},"completion_review":{"input_sha256":null,"invocations":0,"result_sha256":null,"state":"not_started"},"draft_review":{"input_sha256":"f0d5911c136769e9cd7ad900ca48c68dd2839309c94082a60ec51f7edf13bb62","invocations":2,"result_sha256":"ac71e0cb4b0b822403e01ed208bb2ea4b77d9738cb39675a2e89979344774087","state":"blocked"},"execution_parent":null,"goal_id":"74f45ad9-2bc6-4d22-8b7f-f782465413bf","implementation_commit":null,"plan_path":"docs/plans/active/session-relay-payload-boundary.md","plan_sha256":"c1ac09566a37a3bf132f309c644893e82d997e71234f692dfecbc0ec12e39220","repository_id":"DocksDocks/docks","requested_effects":["local"],"risk":"sensitive","run_id":"e5b928f0-3da8-4689-add3-af0cca5c96e4","schema":1,"source_base":"e0e81e71ffac6f4dcd33566ecaeb66976cff0da5","source_sha256":"f212a00206f37965623262232e571194598175a4a4e3b23b42c38f04d1a45596"}

Plan-attempt-history: {"authorization_source_sha256":"519c78c0e193f78b4228e50d35f9424cc798c8fde78ef638d05428ae500eb3d9","plan_bytes_sha256":"41aa7abe61ad154755547a432fe179cfb647051ad33b8136fe46464e7025ef03","replacement_run_id":"e5b928f0-3da8-4689-add3-af0cca5c96e4","run":{"acceptance":null,"blocker":{"evidence_sha256":"c6ac2d4a9e01e7112c9566fcb4eb3e9b5509bec08021ef3f07b70ab4adfde19d","kind":"review_failed"},"completion_review":{"input_sha256":null,"invocations":0,"result_sha256":null,"state":"not_started"},"draft_review":{"input_sha256":"574d4365a05292d2deae55ab64fe9700773c4e9baf67b1c32cc796e98360587e","invocations":2,"result_sha256":"c6ac2d4a9e01e7112c9566fcb4eb3e9b5509bec08021ef3f07b70ab4adfde19d","state":"blocked"},"execution_parent":null,"goal_id":"74f45ad9-2bc6-4d22-8b7f-f782465413bf","implementation_commit":null,"plan_path":"docs/plans/active/session-relay-payload-boundary.md","plan_sha256":"08e24f276c077801b1823a10f012935745b9be06c1443283853f689d89d01645","repository_id":"DocksDocks/docks","requested_effects":["local"],"risk":"sensitive","run_id":"d49e7c59-a92d-4dee-9209-650f1c9e0ab6","schema":1,"source_base":"195f96adb69f9f1c001d0ffdb18a457abfbd12cd","source_sha256":"a6557771021e09dc6a22556c2ead3782b45caaa8b5a2580b3e28c662ededdc8a"},"schema":1,"status":"blocked","successor_run_sha256":"e5271afff47d5a3486b47b8361d98ea95e428e67898d73d8df8d2331e460e3d1"}
...
Pre-implementation falsifiability probes for the successor run, re-measured at this source_base
after the predecessor was blocked. Each acceptance row was exercised before any implementation
byte changed, so a row already green cannot be mistaken for one the work will make green.
Six of the nine rows are red (A1, A3, A4, A5, A6, A9). A2 is green and was proven to discriminate
by a planted unregistered suite that turned it red, restored byte-identical. A7 and A8 are
pre-move gate baselines.

The predecessor run blocked with review_failed after draft invocation 2 of 2 returned a fourth
finding: the sealed manifest carried 199 entries against 206 declared. That was a defect in the
dispatch driver, which read the affected-path list from the plan on disk while binding plan_sha256
to the --body candidate. It is fixed in 51395a0 with a candidate-scope probe, so this run seals the
scope it declares. The plan body is inherited unchanged apart from one numeric step citation that
the successor self-check rejected.

Pre-implementation falsifiability probes for the successor run, measured at this source_base
before any implementation byte changed. Six of the nine rows are red (A1, A3, A4, A5, A6, A9).
A2 is green and was proven to discriminate by a planted unregistered suite that turned it red,
restored byte-identical. A7 and A8 are pre-move gate baselines.

The predecessor blocked with review_failed after draft invocation 2 of 2 found the sealed manifest
carrying 199 entries against 206 declared - a dispatch-driver defect that read the affected-path
list from the plan on disk while binding plan_sha256 to the --body candidate. Fixed in 51395a0
with a candidate-scope probe, so this run seals the scope it declares.

Draft invocation 1 of this run returned one finding, reproduced and accepted: step:stale_refs named
five other active plans in its acceptance but declared only three, and the two omitted plans each
cite plugins/plan-lifecycle/test/selftest.mjs in affected_paths, in a Steps Files cell, and as an
acceptance command - a path step:move_suites relocates. Both are now in scope and the step retargets
all three citation kinds. The gap was introduced by this run own repair, which folded the sibling
payload relocation into move_suites and so widened what the other plans depend on.

Falsifiability-proof: {"binds":"exit","command_sha256":"d5d4076f388e028981817058befcf3b629e1a76a7c46622cb6648ccb3160c12d","expected_sha256":"e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855","observed":1,"probe":"resolveShardSelection({eventName:'pull_request',baseResolved:true,changedPaths:['src/session-relay/src/main.rs']}) returned ['repo','core','relay'] with reason path-outside-every-plugin-root. The row asserts ['repo','relay'], so it is currently false and the extraRoots work is what closes it.","row_id":"A1","source_base":"e0e81e71ffac6f4dcd33566ecaeb66976cff0da5","step_id":"node scripts/tests/ci-plugin-targeting.mjs"}
Falsifiability-proof: {"binds":"exit","command_sha256":"f791780299b0d2e303a44eca7cdafa15267e4bc8475f7c8d0c582e45afbee831","expected_sha256":"e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855","observed":1,"probe":"Planted scripts/tests/unit/zz-planted-probe.test.mjs (an unregistered suite): node scripts/tests/test-contracts.mjs exited 1. Removed it and re-ran: exit 0, with scripts/config/test-contracts.json byte-identical at sha256 180dfc53a844ddb3caa0cff2988915583fa7859ef4909fef764b54b7b434447f. The row discriminates rather than passing vacuously.","row_id":"A2","source_base":"e0e81e71ffac6f4dcd33566ecaeb66976cff0da5","step_id":"node scripts/tests/test-contracts.mjs"}
Falsifiability-proof: {"binds":"exit","command_sha256":"637c24ff47141ce59c8904e577616ff73b49f87732f6ada6f5f8fd8d085d597f","expected_sha256":"e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855","observed":1,"probe":"node scripts/plugins/payload-guard.mjs: exit 1, the module does not exist yet. Enumerating tracked entries outside the allowlist returns plugins/plan-lifecycle/compatibility.json, plugins/plan-lifecycle/test, plugins/effect-kit/test, plugins/session-relay/rust and plugins/session-relay/test - the exact set steps 2 and 3 relocate; plugins/docks is already clean.","row_id":"A3","source_base":"e0e81e71ffac6f4dcd33566ecaeb66976cff0da5","step_id":"node scripts/plugins/payload-guard.mjs"}
Falsifiability-proof: {"binds":"exit","command_sha256":"d2ca56ee3b791cc8f4876f93d864b2c30db8c8ab3f859201d9006d70a4f0cd66","expected_sha256":"e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855","observed":1,"probe":"node --test scripts/tests/unit/payload-guard.test.mjs: exit 1, the test does not exist yet.","row_id":"A4","source_base":"e0e81e71ffac6f4dcd33566ecaeb66976cff0da5","step_id":"node --test scripts/tests/unit/payload-guard.test.mjs"}
Falsifiability-proof: {"binds":"match","command_sha256":"db065852200564330370bf4b3b37e08668c399a1bd7ec3679d17a0ba83f9f86e","expected_sha256":"e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855","observed":{"matcher":"equals 12","result":"98"},"probe":"git ls-files plugins/session-relay | wc -l reports 98 tracked files. The row asserts 12, so it is false by 86 files - exactly the count steps 2 and 3 relocate.","row_id":"A5","source_base":"e0e81e71ffac6f4dcd33566ecaeb66976cff0da5","step_id":"git ls-files plugins/session-relay \\| wc -l"}
Falsifiability-proof: {"binds":"exit","command_sha256":"cbbbfe9e9c0edc96f8b332109231d3f2c97b76f78c6dd452ab2a88a23fe7e250","expected_sha256":"e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855","observed":1,"probe":"cargo build --manifest-path src/session-relay/Cargo.toml --release --locked: exit 1, no manifest at that path. The row cannot pass before step 2 moves the crate.","row_id":"A6","source_base":"e0e81e71ffac6f4dcd33566ecaeb66976cff0da5","step_id":"cargo build --manifest-path src/session-relay/Cargo.toml --release --locked"}
Falsifiability-proof: {"binds":"exit","command_sha256":"cbbbfe9e9c0edc96f8b332109231d3f2c97b76f78c6dd452ab2a88a23fe7e250","expected_sha256":"e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855","observed":0,"probe":"node scripts/ci.mjs --plugin session-relay: exit 0 at this source_base. Pre-move baseline. Caveat: across eight gate invocations this session one targeted run and one full run each failed once and neither reproduced, so a post-move red here must be reproduced before it is attributed to the move.","row_id":"A7","source_base":"e0e81e71ffac6f4dcd33566ecaeb66976cff0da5","step_id":"node scripts/ci.mjs --plugin session-relay"}
Falsifiability-proof: {"binds":"exit","command_sha256":"c09ec2ae510b2c875845da1722b3f970caa713f7fcad33b02b82c6e5664b7c25","expected_sha256":"e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855","observed":0,"probe":"node scripts/ci.mjs: exit 0 at this source_base across 4 plugins plus repo-wide. Pre-move baseline, same non-reproducing-flake caveat as A7.","row_id":"A8","source_base":"e0e81e71ffac6f4dcd33566ecaeb66976cff0da5","step_id":"node scripts/ci.mjs"}
Falsifiability-proof: {"binds":"match","command_sha256":"1c16d8a1c85f5e3ec27900d0f82ee59aa3975e1c35a5b7d16288c65803b589de","expected_sha256":"df301f89b7059d92f0c7d4b95fc5fc2fe1b18e74cf9c5c33b7ee3387f27bc0ae","observed":{"matcher":"no output","result":"3 lines"},"probe":"The scan - Markdown only, excluding docs/plans/, scripts/tests/fixtures/, node_modules and .git - reports exactly 3 lines, in .github/AGENTS.md, plugins/session-relay/AGENTS.md and scripts/AGENTS.md, all owned by step:shipped_prose.","row_id":"A9","source_base":"e0e81e71ffac6f4dcd33566ecaeb66976cff0da5","step_id":"grep -rn 'plugins/session-relay/rust\\|plugins/session-relay/test' --include=*.md . \\| grep -vE 'docs/plans/\\|scripts/tests/fixtures/\\|node_modules\\|^\\./\\.git/'"}
