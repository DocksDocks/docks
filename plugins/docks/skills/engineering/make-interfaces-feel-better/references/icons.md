...
Analyze composite icons part by part: an overlay may keep its position even when the base glyph flips. For accessible names and assistive-technology treatment, use the accessibility skill; this skill only covers the icon's visual polish.
